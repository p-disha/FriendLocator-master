...
public class SettingsActivity extends Activity {
    ...
    public void onShareLocationClick(View view){
        Log.d(ACTIVITY, "onShareLocationClick() clicked");
        ParseUser user = ParseUser.getCurrentUser();
        Log.d(ACTIVITY, " " + user.getEmail());
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT,"My location - http://maps.google.com?q=" +location.getLatitude() + "," +location.getLongitude());
